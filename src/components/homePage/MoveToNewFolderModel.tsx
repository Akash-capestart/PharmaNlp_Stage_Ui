...
type MoveToNewFolderModalProps = {
...
export function MoveToFolderModal2({ closeModalHandler } : MoveToNewFolderModalProps) {
  ...
  return (
    <div className="alert-box position-absolute" style={{ left: 450 }}>
